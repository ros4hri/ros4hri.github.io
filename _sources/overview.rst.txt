...
**ROS for Human-Robot Interaction** (or ROS4HRI in short) is an open-source
ROS standard and a set of ROS packages to facilitate the development of
Human-Robot Interaction (HRI) capabilities on robots.
...
Read more in :ref:`standard <standard>`.
